...
export function EventsPage() {
  ...
  }, [data, status, eventType, search])

  return (
    <div>
      {/* ── Hero ── */}
      <section className="relative overflow-hidden bg-[#1e1b4b] px-4 py-16 text-center">
      ...
      {/* ── Filters ── */}
      <div className="sticky top-16 z-40 border-b border-border bg-background/90 backdrop-blur-sm">
      ...
      <main className="mx-auto max-w-7xl px-4 py-8">
        ...
        {!isLoading && !isError && filtered.length === 0 && (
          <div className="py-16 text-center">
            ...
            <Button variant="ghost" size="sm" className="mt-3" onClick={() => { setSearch(''); setStatus('ALL'); setEventType('ALL') }}>
              Clear filters
            </Button>
          </div>
        )}
